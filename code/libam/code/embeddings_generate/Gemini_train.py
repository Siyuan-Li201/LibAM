...
if __name__ == '__main__':
        ...
        if i % SHOW_FREQ == 0:
            ...
            with torch.no_grad():
                ...
                if np.mean(loss_val) < best_loss:
                    torch.save(net, SAVE_PATH + "/gnn-best.pt")
                    patience = 5
    ...
    # auc1, fpr1, tpr1, thres1 = contra_loss_show(net, testLoader, DEVICE)
    ...
    # print(thres1[index])
    #
    # auc2, fpr2, tpr2, thres2 = contra_loss_show(net, validLoader, DEVICE)
